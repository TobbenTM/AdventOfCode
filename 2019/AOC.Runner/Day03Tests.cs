...
namespace AOC.Runner
{
    public class Day03Tests
    {
        ...
        public void Part1()
        {
            var result = Day03.SolvePart1(_input1, _input2);
            Assert.Equal(865, result);
        }

        [Fact]
        public void Part2()
        {
            var result = Day03.SolvePart2(_input1, _input2);
            Assert.Equal(35038, result);
        }

        private readonly string[] _input1 = new[] {
        ...
        private readonly string[] _input2 = new[] {
