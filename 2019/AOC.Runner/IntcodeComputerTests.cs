...
namespace AOC.Runner
{
    public class IntcodeComputerTests
    {
        ...
        public async Task ShouldAlterFirstSlot(int expected, params int[] program)
        {
        ...
        public async Task ShouldRunSmallerPrograms(string description, int expected, int input, params int[] program)
        {
        ...
        [Fact]
        public async Task ShouldSupportOutputtingLargeNumbers1()
        {
            var program = new long[] { 109, 1, 204, -1, 1001, 100, 1, 100, 1008, 100, 16, 101, 1006, 101, 0, 99 };
            var computer = new Computer(program);
            var output = await computer.ComputeAsync();
            Assert.Equal(program, output);
        }

        [Fact]
        public async Task ShouldSupportOutputtingLargeNumbers2()
        {
        ...
        [Fact]
        public async Task ShouldSupportOutputtingLargeNumbers3()
        {
