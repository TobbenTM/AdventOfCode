...
namespace AOC.Runner
{
    public class Day4Tests
    {
        ...
        public void Part1()
        {
            var result = Day4.SolvePart1(_input);
            Assert.Equal(77084, result);
        }

        [Fact]
        public void Part2()
        {
            var result = Day4.SolvePart2(_input);
            Assert.Equal(23047, result);
        }
        ...
        public void ShouldParseStartsShiftEvent()
        {
            ...
            Assert.Equal(new DateTime(1518, 10, 10, 23, 52, 0), result.Timestamp);
        }
